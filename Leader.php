    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="sidebar-desktop w-64 main-gradient text-white flex flex-col shadow-2xl">
            ...
            <div class="p-4 border-t border-white/20">
                <button class="w-full flex items-center py-3 px-4 text-sites-light font-semibold text-left hover:bg-white/10 rounded-lg transition-colors">
        ...
        <div class="bg-white rounded-xl shadow-2xl max-w-2xl w-full flex flex-col relative">
            ...
            <div class="p-8">
                <div class="flex items-center space-x-6 mb-6">
                    <div id="modal-member-avatar" class="w-24 h-24 bg-sites-light rounded-full flex items-center justify-center ring-4 ring-white shadow-lg">
                        <span class="text-4xl font-bold text-sites-dark"></span>
                    </div>
                    <div>
                ...
                <div class="grid grid-cols-3 gap-4 text-sm mb-6">
                    ...
                    <div class="p-3 bg-gray-50 rounded-lg">
                        <p class="text-gray-500 uppercase tracking-wider font-semibold">ID</p>
                        <p id="modal-member-student-id" class="font-bold text-base mt-1"></p>
                    </div>
                    <div class="p-3 bg-gray-50 rounded-lg">
                        <p class="text-gray-500 uppercase tracking-wider font-semibold">Contact</p>
        ...
        <div class="bg-white rounded-xl shadow-2xl max-w-md w-full relative overflow-hidden">
            ...
            <div id="edit-profile-main-view" class="edit-profile-view active flex-col">
                <header class="p-4 flex items-center justify-center border-b relative">
                    ...
                    <button onclick="hideEditProfileModal()" class="absolute right-4 text-gray-500 hover:text-gray-800"><i data-lucide="x" class="w-6 h-6"></i></button>
                </header>
                <div class="p-6 flex flex-col items-center">
                    <div id="edit-modal-avatar" class="w-24 h-24 bg-sites-light rounded-full flex items-center justify-center ring-4 ring-white shadow-lg mb-2">
                        <span class="text-4xl font-bold text-sites-dark"></span>
                    </div>
                    <button class="font-semibold text-sites-accent">Change profile photo</button>
                </div>
                <div>
                     ...
                     <div onclick="showEditView('studentId')" class="flex justify-between items-center p-4 border-b cursor-pointer hover:bg-gray-50">
                    ...
                    <div onclick="showEditView('password')" class="flex justify-between items-center p-4 border-b cursor-pointer hover:bg-gray-50">
            ...
            <div id="edit-profile-email-view" class="edit-profile-view flex-col">
                <header class="p-4 flex items-center border-b relative">
                    <button onclick="showEditView('main')" class="absolute left-4 text-gray-600 hover:text-gray-900"><i data-lucide="chevron-left" class="w-6 h-6"></i></button>
                    <h2 class="text-lg font-bold text-center w-full">Email</h2>
                    <button id="save-email-btn" onclick="saveProfileField('email')" class="hidden absolute right-4 text-sites-accent font-semibold">Save</button>
                </header>
                <div class="p-6 space-y-2 flex-grow">
                    <label for="edit-input-email" class="text-xs text-gray-500">Email Address</label>
             ...
             <!-- Edit Student ID View -->
            <div id="edit-profile-studentId-view" class="edit-profile-view flex-col">
                <header class="p-4 flex items-center border-b relative">
                    <button onclick="showEditView('main')" class="absolute left-4 text-gray-600 hover:text-gray-900"><i data-lucide="chevron-left" class="w-6 h-6"></i></button>
                    <h2 class="text-lg font-bold text-center w-full">Student ID</h2>
                    <button id="save-studentId-btn" onclick="saveProfileField('studentId')" class="hidden absolute right-4 text-sites-accent font-semibold">Save</button>
                </header>
                <div class="p-6 space-y-2 flex-grow">
                    <label for="edit-input-studentId" class="text-xs text-gray-500">Student ID</label>
                    <input id="edit-input-studentId" type="text" class="w-full text-lg py-2 bg-transparent border-b focus:outline-none focus:border-sites-accent">
                </div>
            </div>
            ...
            <div id="edit-profile-contact-view" class="edit-profile-view flex-col">
                <header class="p-4 flex items-center border-b relative">
                    ...
                    <h2 class="text-lg font-bold text-center w-full">Contact</h2>
                     <button id="save-contact-btn" onclick="saveProfileField('contact')" class="hidden absolute right-4 text-sites-accent font-semibold">Save</button>
                </header>
                 <div class="p-6 space-y-2 flex-grow">
                    <label for="edit-input-contact" class="text-xs text-gray-500">Contact Number</label>
            ...
            <div id="edit-profile-password-view" class="edit-profile-view flex-col">
                <header class="p-4 flex items-center border-b relative">
                    <button onclick="showEditView('main')" class="absolute left-4"><i data-lucide="chevron-left" class="w-6 h-6"></i></button>
                    <h2 class="text-lg font-bold text-center w-full">Change Password</h2>
                </header>
                <div class="p-6 space-y-4 flex-grow">
                    <div>
                        <label for="current-password" class="text-xs text-gray-500">Current Password</label>
                        <input id="current-password" type="password" class="w-full text-lg py-2 bg-transparent border-b focus:outline-none focus:border-sites-accent">
                    </div>
                    <div>
                        <label for="new-password" class="text-xs text-gray-500">New Password</label>
                        <input id="new-password" type="password" class="w-full text-lg py-2 bg-transparent border-b focus:outline-none focus:border-sites-accent">
                    </div>
                    <div>
                        <label for="confirm-password" class="text-xs text-gray-500">Confirm New Password</label>
                        <input id="confirm-password" type="password" class="w-full text-lg py-2 bg-transparent border-b focus:outline-none focus:border-sites-accent">
                    </div>
                </div>
                <footer class="p-4">
                    <button onclick="saveNewPassword()" class="w-full bg-sites-accent text-white font-bold py-2 rounded-lg hover:opacity-90 transition-opacity">Save Password</button>
                </footer>
            </div>
        </div>
    </div>
