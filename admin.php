    ...
    <div id="app">
        ...
        <main class="main-grid">
            ...
            <section class="card form-section">
                ...
                <!-- NOTE: The action of this form will be handled by PHP/SQL backend -->
                <form id="addUserForm" class="form-container" method="POST" action="add_user.php">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="newPassword" name="newPassword" required 
                               placeholder="e.g., SecurePassword1">
                    </div>
